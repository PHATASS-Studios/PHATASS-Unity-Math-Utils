...
//
// extension methods
		public static IEnumerable<Transform> EToRecursiveChildrenEnumerable (this Transform transform, bool includeRootTransform = false)
		{ return new TransformChildrenRecursiveEnumerable(transform, includeRootTransform); }

		public static IEnumerable<Transform> EToRecursiveChildrenEnumerable (this UnityEngine.GameObject gameObject, bool includeRootTransform = false)
		{ return gameObject.transform.EToRecursiveChildrenEnumerable(includeRootTransform); }
//ENDOF extension methods

// IEnumerables/IEnumerators
		private struct TransformChildrenRecursiveEnumerable : IEnumerable<Transform>
		{
			IEnumerator IEnumerable.GetEnumerator ()
			{ return new TransformChildrenRecursiveEnumerator(root, includeRootTransform); }
		...
		private class TransformChildrenRecursiveEnumerator
		...
		//Constructor & initialization
			public TransformChildrenRecursiveEnumerator (Transform root, bool includeRootTransform = true)
			{
		...
		//private fields
			...
			private TransformChildrenRecursiveEnumerator subEnumerator;	//IEnumerator used to iterate over the children
		//ENDOF private
		...
		//private methods
			private bool MoveNext ()
			{
				...
				if (this.subEnumerator == null) { this.subEnumerator = new TransformChildrenRecursiveEnumerator(null, true); }
